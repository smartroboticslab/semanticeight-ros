...
class UtilitiesTest : public ::testing::Test {
    ...
    virtual void SetUp()
    {
        ...
        uint16_t* depth_uint16_data = reinterpret_cast<uint16_t*>(depth_uint16_msg.data.data());
        float* depth_float_data = reinterpret_cast<float*>(depth_float_msg.data.data());
        // Set the image data
...
TEST_F(UtilitiesTest, uint16ToSupereightDepth)
{
    ...
    ASSERT_FALSE(std::memcmp(converted_depth.get(), desired_se_depth.get(), desired_se_depth_size));
}
...
TEST_F(UtilitiesTest, RGBToSupereightRGB)
{
    ...
    ASSERT_FALSE(std::memcmp(converted_rgb.get(), desired_se_rgb.get(), desired_se_rgb_size));
}
